...
const socialMediaLinks = {
  github: "https://github.com/YusefShakhtour",
  linkedin: "https://www.linkedin.com/in/YusefShakhtour/",
  gmail: "yusefshakhtour@gmail.com",
  ...
  schools: [
    {
      ...
      subHeader: "Bachelor of Science in Computer Science with an AI Concentration and minor in Mathematics",
...
const bigProjects = {
  ...
  projects: [
    {
      image: require("./assets/images/CoffeeMaker.png"),
      projectName: "CoffeeMaker",
      projectDesc: "Final project that was implemented and improved upon over the course of an entire semester for my Software Engineering course. Allowed customers to order through the website and employees to fulfill those orders and manage inventory.",
      footerLink: [
        {
          name: "Youtube Demo",
          url: ""
